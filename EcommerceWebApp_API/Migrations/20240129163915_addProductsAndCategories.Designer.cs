...
namespace EcommerceWebApp_API.Migrations
{
    ...
    [Migration("20240129163915_addProductsAndCategories")]
            ...
            modelBuilder.Entity("CategoryProduct", b =>
                {
                    ...
                    b.Property<int>("ProductsProductionId")
                        .HasColumnType("int");

                    b.HasKey("CategoriesCategoryId", "ProductsProductionId");

                    b.HasIndex("ProductsProductionId");
            ...
            modelBuilder.Entity("CategoryProduct", b =>
                {
                    ...
                    b.HasOne("EcommerceWebApp_API.Models.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductsProductionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
